...
import { $getNearestBlockElementAncestorOrThrow } from '@payloadcms/richtext-lexical/lexical/utils'
...
const clearFormatting = ({editor}:{ editor: LexicalEditor }) => {
  editor.update(() => {
  ...
  items: [
    {
      key: 'clearFormat',
      label: 'Clear Format',
      ChildComponent: Eraser,
      onSelect: clearFormatting
    }
  ]
}
export const ClearFormatClient = createClientFeature(({
  toolbarInline: {
    groups: [
      toolbarGroup
    ]
